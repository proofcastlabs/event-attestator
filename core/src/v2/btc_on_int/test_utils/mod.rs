...
write_btc_paths_and_getter_fxn!(
    0 => "src/v2/btc_on_int/test_utils/btc-testnet-block-2163202.json",
    1 => "src/v2/btc_on_int/test_utils/btc-testnet-block-2163203.json",
    2 => "src/v2/btc_on_int/test_utils/btc-testnet-block-2163204.json",
    3 => "src/v2/btc_on_int/test_utils/btc-testnet-block-2163205.json"
);
...
write_eth_paths_and_getter_fxn!(
    0 => "src/v2/btc_on_int/test_utils/eth-ropsten-block-12000341.json",
    1 => "src/v2/btc_on_int/test_utils/eth-ropsten-block-12000342.json",
    2 => "src/v2/btc_on_int/test_utils/eth-ropsten-block-12000343.json",
    3 => "src/v2/btc_on_int/test_utils/eth-ropsten-block-12000344.json"
);
