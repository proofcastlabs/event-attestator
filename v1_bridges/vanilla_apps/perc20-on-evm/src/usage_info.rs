...
Usage:  perc20-on-evm [--help]
        ...
        perc20-on-evm initializeEth (<blockJson> | --file=<path>) [--vaultAddress=<hex>] [--chainId=<uint>] [--gasPrice=<uint>] [--confs=<uint>]
        perc20-on-evm debugGetAllDbKeys [--sig=<hex>]
        perc20-on-evm debugGetKeyFromDb <key> [--sig=<hex>]
        perc20-on-evm debugSetEthGasPrice <gasPrice> [--sig=<hex>]
        perc20-on-evm debugSetEvmGasPrice <gasPrice> [--sig=<hex>]
        perc20-on-evm debugSetEthAccountNonce <nonce> [--sig=<hex>]
        perc20-on-evm debugSetEvmAccountNonce <nonce> [--sig=<hex>]
        perc20-on-evm debugMigrateContract <ethAddress> [--sig=<hex>]
        perc20-on-evm debugAddSupportedToken <ethAddress> [--sig=<hex>]
        perc20-on-evm debugRemoveDebugSigner <ethAddress> [--sig=<hex>]
        perc20-on-evm debugSetKeyInDbToValue <key> <value> [--sig=<hex>]
        perc20-on-evm debugRemoveSupportedToken <ethAddress> [--sig=<hex>]
        perc20-on-evm debugAddDebugSigner <name> <ethAddress> [--sig=<hex>]
        perc20-on-evm debugAddDebugSigners <debugSignersJson> [--sig=<hex>]
        perc20-on-evm debugRemoveDictionaryEntry <ethAddress> [--sig=<hex>]
        perc20-on-evm debugSetFeeBasisPoints <ethAddress> <fee> [--sig=<hex>]
        perc20-on-evm debugSetAccruedFees <ethAddress> <amount> [--sig=<hex>]
        perc20-on-evm debugMigrateSingle <ethAddress> <tokenAddress> [--sig=<hex>]
        perc20-on-evm debugWithdrawFees <tokenAddress> <recipientAddress> [--sig=<hex>]
        perc20-on-evm debugReprocessEthBlock (<blockJson> | --file=<path>) [--sig=<hex>]
        perc20-on-evm debugReprocessEvmBlock (<blockJson> | --file=<path>) [--sig=<hex>]
        perc20-on-evm debugAddDictionaryEntry (<entryJson> | --file=<path>) [--sig=<hex>]
        perc20-on-evm debugResetEthChain (<blockJson> | --file=<path>) [--confs=<uint>] [--sig=<hex>]
        perc20-on-evm debugResetEvmChain (<blockJson> | --file=<path>) [--confs=<uint>] [--sig=<hex>]
        perc20-on-evm debugReprocessEthBlockWithFeeAccrual (<blockJson> | --file=<path>) [--sig=<hex>]
        perc20-on-evm debugReprocessEvmBlockWithFeeAccrual (<blockJson> | --file=<path>) [--sig=<hex>]
        perc20-on-evm debugReprocessEthBlockWithNonce <nonce> (<blockJson> | --file=<path>) [--sig=<hex>]
        perc20-on-evm debugReprocessEvmBlockWithNonce <nonce> (<blockJson> | --file=<path>) [--sig=<hex>]
...
Options:
    ...
    --vaultAddress=<hex>                ❍ ETH address of the pToken vault.
