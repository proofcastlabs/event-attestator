...
pub fn maybe_parse_peg_in_info_from_canon_block_and_add_to_state<D>(state: EthState<D>) -> Result<EthState<D>>
where
    D: DatabaseInterface,
{
...
pub fn maybe_filter_peg_in_info_in_state<D>(state: EthState<D>) -> Result<EthState<D>>
where
    D: DatabaseInterface,
{
