            ...
            pub fn new(db: &'a D) -> Self {
                if $is_for_eth {
                    ...
                    Self {
                        ...
                        erc777_proxy_contract_address_key: EVM_ERC777_PROXY_CONTACT_ADDRESS_KEY.to_vec(),
...
make_eth_db_utils_struct!(EthDbUtils, true);
make_eth_db_utils_struct!(EvmDbUtils, false);
