...
pub const ETH_ON_EVM_PEG_IN_EVENT_TOPIC_HEX: &str = "f7279bc9441f2a98e9a2e0f58cf873aee8f8300a76f99114d073c852ae1b234f";
pub const ETH_ON_EVM_REDEEM_EVENT_TOPIC_HEX: &str = "a3aff243d9d0c944de98e4e2a6a4dd983fd817a1b8835e0e00f103a6d27e4513";
    ...
    pub static ref ETH_ON_EVM_PEG_IN_EVENT_TOPIC: [EthHash; 1] = {
        [EthHash::from_slice(
            &hex::decode(ETH_ON_EVM_PEG_IN_EVENT_TOPIC_HEX)
                .expect("✘ Invalid hex in `ETH_ON_EVM_PEG_IN_EVENT_TOPIC_HEX`!"),
        )]
    };
}
    ...
    pub static ref ETH_ON_EVM_REDEEM_EVENT_TOPIC: [EthHash; 1] = {
        [EthHash::from_slice(
            &hex::decode(ETH_ON_EVM_REDEEM_EVENT_TOPIC_HEX)
                .expect("✘ Invalid hex in `ETH_ON_EVM_REDEEM_EVENT_TOPIC_HEX`!"),
        )]
    };
}
...
lazy_static! {
    pub static ref EOS_ON_ETH_ETH_TX_INFO_EVENT_TOPIC: [EthHash; 1] = {
        [EthHash::from_slice(
            &hex::decode(EOS_ON_ETH_ETH_TX_INFO_EVENT_TOPIC_HEX)
                .expect("✘ Invalid hex in `EOS_ON_ETH_ETH_TX_INFO_EVENT_TOPIC`!"),
        )]
    };
}
...
lazy_static! {
    pub static ref BTC_ON_ETH_REDEEM_EVENT_TOPIC: [EthHash; 1] = {
        [EthHash::from_slice(
            &hex::decode(BTC_ON_ETH_REDEEM_EVENT_TOPIC_HEX).expect("✘ Invalid hex in `BTC_ON_ETH_REDEEM_EVENT_TOPIC`"),
        )]
    };
}
