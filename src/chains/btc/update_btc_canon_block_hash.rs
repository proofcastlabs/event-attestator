...
fn does_canon_block_require_updating<D>(db: &D, calculated_canon_block: &BtcBlockInDbFormat) -> Result<bool>
where
    D: DatabaseInterface,
{
...
pub fn maybe_update_btc_canon_block_hash<D>(state: BtcState<D>) -> Result<BtcState<D>>
where
    D: DatabaseInterface,
{
