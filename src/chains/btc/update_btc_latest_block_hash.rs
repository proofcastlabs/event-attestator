use crate::{
    chains::btc::{
        btc_database_utils::{get_btc_latest_block_from_db, put_btc_latest_block_hash_in_db},
        btc_state::BtcState,
    },
...
pub fn maybe_update_btc_latest_block_hash<D>(state: BtcState<D>) -> Result<BtcState<D>>
where
    D: DatabaseInterface,
{
