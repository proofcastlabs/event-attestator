...
pub fn get_sample_peg_in_1_submission_material() -> EthSubmissionMaterial {
    EthSubmissionMaterial::from_str(&read_to_string("src/v2/erc20_on_int/test_utils/eth-peg-in-block-1.json").unwrap())
        .unwrap()
}

pub fn get_sample_peg_in_1_submission_string() -> String {
    read_to_string("src/v2/erc20_on_int/test_utils/eth-peg-in-block-1.json").unwrap()
}

pub fn get_sample_goerli_peg_in_submission_string() -> String {
    read_to_string("src/v2/erc20_on_int/test_utils/goerli-peg-in-block.json").unwrap()
}

pub fn get_sample_sepolia_peg_in_submission_string() -> String {
    read_to_string("src/v2/erc20_on_int/test_utils/sepolia-peg-in-block.json").unwrap()
}
...
fn get_sample_submission_material_string_n(chain_type: &str, n: usize) -> Result<String> {
    let path = format!(
        "src/v2/erc20_on_int/test_utils/{}-submission-material-{}.json",
        chain_type, n
    );
...
pub fn get_sample_eth_init_block_json_string() -> String {
    read_to_string("src/v2/erc20_on_int/test_utils/eth-core-init-block.json").unwrap()
}

pub fn get_sample_goerli_peg_in_init_block_json_string() -> String {
    read_to_string("src/v2/erc20_on_int/test_utils/goerli-core-peg-in-init-block.json").unwrap()
}

pub fn get_sample_sepolia_init_block_json_string() -> String {
    read_to_string("src/v2/erc20_on_int/test_utils/sepolia-init-block.json").unwrap()
}

pub fn get_sample_int_init_block_json_string() -> String {
    read_to_string("src/v2/erc20_on_int/test_utils/int-core-init-block.json").unwrap()
}

pub fn get_sample_peg_out_json_string() -> String {
    read_to_string("src/v2/erc20_on_int/test_utils/int-peg-out-block-1.json").unwrap()
}
