...
write_int_paths_and_getter_fxn!(
    0 => "src/v2/int_on_algo/test_utils/int-block-12221813.json",
    1 => "src/v2/int_on_algo/test_utils/int-block-12221814.json",
    2 => "src/v2/int_on_algo/test_utils/int-block-12322610.json",
    3 => "src/v2/int_on_algo/test_utils/int-block-12322611.json",
    4 => "src/v2/int_on_algo/test_utils/int-block-12342413.json",
    5 => "src/v2/int_on_algo/test_utils/int-block-12342414.json"
);

write_algo_paths_and_getter_fxn!(
    0 => "src/v2/int_on_algo/test_utils/algo-block-20642396.json",
    1 => "src/v2/int_on_algo/test_utils/algo-block-20642397.json",
    2 => "src/v2/int_on_algo/test_utils/algo-block-20642398.json",
    3 => "src/v2/int_on_algo/test_utils/algo-block-21515430.json",
    4 => "src/v2/int_on_algo/test_utils/algo-block-21515431.json",
    5 => "src/v2/int_on_algo/test_utils/algo-block-21530957.json",
    6 => "src/v2/int_on_algo/test_utils/algo-block-21530958.json"
);
