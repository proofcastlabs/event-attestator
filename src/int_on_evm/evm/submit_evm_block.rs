    ...
    fn should_submit_evm_block_successfully() {
        ...
        let expected_result_json = json!({
            ...
            "int_signed_transactions": [{
                ...
                "int_account_nonce": 0,
                "evm_latest_block_number": 11544951,
        ...
        assert_eq!(
            result.int_signed_transactions[0].evm_latest_block_number,
            expected_result.int_signed_transactions[0].evm_latest_block_number
        );
        assert_eq!(
