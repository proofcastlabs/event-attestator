...
use crate::{
    chains::eth::{
        ...
        eth_contracts::erc777::{encode_erc777_mint_fxn_maybe_with_data, ERC777_MINT_WITH_DATA_GAS_LIMIT},
        eth_crypto::{
...
mod tests {
    ...
    use crate::{
        ...
        int_on_evm::test_utils::{get_sample_evm_private_key, get_sample_evm_tx_infos, get_sample_token_dictionary},
    };
