...
pub fn get_linker_hash_or_genesis_hash<D: DatabaseInterface>(db: &D) -> Result<sha256d::Hash> {
...
fn get_new_linker_hash<D: DatabaseInterface>(db: &D, block_hash_to_link_to: &sha256d::Hash,) -> Result<sha256d::Hash> {
