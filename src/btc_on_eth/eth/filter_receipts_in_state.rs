use crate::{
    chains::eth::{
        eth_contracts::erc777::{ERC_777_REDEEM_EVENT_TOPIC_WITHOUT_USER_DATA,ERC_777_REDEEM_EVENT_TOPIC_WITH_USER_DATA},
...
pub fn filter_receipts_for_btc_on_eth_redeem_events_in_state<D: DatabaseInterface>(
    ...
    state
        ...
        .get_receipts_containing_log_from_address_and_with_topics(
            ...
            &[*ERC_777_REDEEM_EVENT_TOPIC_WITHOUT_USER_DATA, *ERC_777_REDEEM_EVENT_TOPIC_WITH_USER_DATA],
        )
