use crate::{
    chains::{btc::btc_database_utils::increment_btc_account_nonce_in_db, eth::eth_state::EthState},
    traits::DatabaseInterface,
    types::Result,
};

pub fn maybe_increment_btc_nonce_in_db_and_return_state<D>(state: EthState<D>) -> Result<EthState<D>>
where
    D: DatabaseInterface,
{
