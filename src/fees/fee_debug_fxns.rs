use crate::{
    fees::fee_database_utils::{
        put_btc_on_eth_peg_in_basis_points_in_db,
        put_btc_on_eth_peg_out_basis_points_in_db,
    },
...
// TODO way to create a tx to ge the fee amount sent to an address
...
/// database.
pub fn debug_put_btc_on_eth_peg_in_basis_points_in_db<D: DatabaseInterface>(db: &D, basis_points: u64) -> Result<String> {
...
/// This function sets to the given value the `BTC-on-ETH` peg-in basis-points in the encrypted
/// database.
pub fn debug_put_btc_on_eth_peg_out_basis_points_in_db<D: DatabaseInterface>(db: &D, basis_points: u64) -> Result<String> {
