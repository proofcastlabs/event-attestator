...
write_int_paths_and_getter_fxn!(
    0 => "src/test_utils/int-submission-material-block-11618226.json",
    1 => "src/test_utils/int-submission-material-block-11618227.json"
);

write_eos_paths_and_getter_fxn!(
    0 => "src/test_utils/eos-init-block-222275383.json",
    1 => "src/test_utils/eos-submission-material-block-222279899.json"
);
