...
pub use self::{
    ...
    btc_state::BtcState,
    btc_submission_material::{parse_submission_material_and_put_in_state, BtcSubmissionMaterialJson},
    btc_transaction::create_signed_raw_btc_tx_for_n_input_n_outputs,
    btc_utils::{create_unsigned_utxo_from_tx, get_hex_tx_from_signed_btc_tx, get_pay_to_pub_key_hash_script},
