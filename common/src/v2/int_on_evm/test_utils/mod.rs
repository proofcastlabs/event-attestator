...
pub fn get_sample_peg_out_submission_material() -> EthSubmissionMaterial {
    EthSubmissionMaterial::from_str(&read_to_string("src/v2/int_on_evm/test_utils/peg-out-block-1.json").unwrap())
        .unwrap()
}

pub fn get_sample_peg_in_submission_material() -> EthSubmissionMaterial {
    EthSubmissionMaterial::from_str(&read_to_string("src/v2/int_on_evm/test_utils/peg-in-block-1.json").unwrap())
        .unwrap()
}
...
pub fn get_sample_evm_init_block_json_string() -> String {
    read_to_string("src/v2/int_on_evm/test_utils/evm-init-block.json").unwrap()
}

pub fn get_sample_evm_goerli_init_block_json_string() -> String {
    read_to_string("src/v2/int_on_evm/test_utils/goerli-core-peg-out-init-block.json").unwrap()
}

pub fn get_sample_int_init_block_json_string() -> String {
    read_to_string("src/v2/int_on_evm/test_utils/int-init-block.json").unwrap()
}

fn get_sample_submission_material_string_n(chain_type: &str, n: usize) -> Result<String> {
    let path = format!(
        "src/v2/int_on_evm/test_utils/{}-submission-material-{}.json",
        chain_type, n
    );
