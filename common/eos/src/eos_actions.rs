...
impl PTokenMintActionWithoutMetadata {
    ...
    pub fn from_str(to: &str, quantity: &str, memo: &str) -> common::Result<Self> {
        Ok(Self::new(
...
impl PTokenPegOutAction {
    pub fn from_str(token_contract: &str, quantity: &str, recipient: &str, metadata: &[u8]) -> common::Result<Self> {
        Ok(Self {
