...
pub const SAMPLE_EOS_BLOCK_AND_ACTION_JSON_PATH_1: &str = "src/eos_test_utils/eos-block-81784220.json";

pub const SAMPLE_EOS_BLOCK_AND_ACTION_JSON_PATH_2: &str = "src/eos_test_utils/eos-block-80440580.json";

pub const SAMPLE_EOS_BLOCK_AND_ACTION_JSON_PATH_3: &str = "src/eos_test_utils/eos-block-84187467.json";

pub const SAMPLE_EOS_BLOCK_AND_ACTION_JSON_PATH_4: &str = "src/eos_test_utils/eos-block-81772484.json";

pub const SAMPLE_EOS_BLOCK_AND_ACTION_JSON_PATH_5: &str = "src/eos_test_utils/eos-block-10800.json";

pub const SAMPLE_EOS_BLOCK_AND_ACTION_JSON_PATH_6: &str = "src/eos_test_utils/jungle-3-block-8242000.json";

pub const SAMPLE_EOS_BLOCK_AND_ACTION_JSON_PATH_7: &str = "src/eos_test_utils/eos-block-10700626.json";

pub const SAMPLE_EOS_BLOCK_AND_ACTION_JSON_PATH_8: &str =
    "src/eos_test_utils/eos-mainnet-block-with-schedule-1714.json";

pub const SAMPLE_EOS_BLOCK_AND_ACTION_JSON_PATH_9: &str = "src/eos_test_utils/eos-j3-block-with-schedule.json";

pub const SAMPLE_EOS_BLOCK_AND_ACTION_JSON_PATH_10: &str =
    "src/eos_test_utils/mainnet-submission-material-with-perc20-redeem.json";

pub const SAMPLE_EOS_BLOCK_AND_ACTION_JSON_PATH_11: &str =
    "src/eos_test_utils/sample-submission-material-with-bad-account-name-parsing.json";

pub const SAMPLE_J3_INIT_BLOCK_JSON_PATH_1: &str = "src/eos_test_utils/jungle-3-init-block-10857380.json";

pub const SAMPLE_J3_INIT_BLOCK_JSON_PATH_2: &str = "src/eos_test_utils/jungle-3-init-block-11879805.json";

pub const SAMPLE_J3_INIT_BLOCK_JSON_PATH_3: &str = "src/eos_test_utils/jungle-3-init-block-11379805.json";

pub const SAMPLE_MAINNET_INIT_BLOCK_JSON_PATH_1: &str = "src/eos_test_utils/mainnet-init-block-125292121.json";

pub const SAMPLE_MAINNET_INIT_BLOCK_JSON_PATH_2: &str = "src/eos_test_utils/mainnet-init-block-125293807.json";

pub const SAMPLE_MAINNET_INIT_BLOCK_JSON_PATH_3: &str = "src/eos_test_utils/mainnet-init-block-125293952.json";

pub const SAMPLE_MAINNET_INIT_BLOCK_JSON_PATH_4: &str =
    "src/eos_test_utils/mainnet-init-block-125293952_with_eos_eth_token_dictionary.json";

pub const SAMPLE_INIT_AND_SUBSEQUENT_BLOCKS_JUNGLE_3_JSON_1: &str =
    "src/eos_test_utils/eos-init-and-subsequent-blocks-jungle-3-1.json";

pub const SAMPLE_INIT_AND_SUBSEQUENT_BLOCKS_MAINNET_JSON_1: &str =
    "src/eos_test_utils/eos-init-and-subsequent-blocks-mainnet-1.json";

pub const SAMPLE_INIT_BLOCK_WITH_V1_SCHEDULE: &str = "src/eos_test_utils/sample_init_block_with_v1_schedule.json";
...
pub fn get_sample_v1_schedule_json_string() -> Result<String> {
    Ok(read_to_string("src/eos_test_utils/sample-schedule-389-v1.json")?)
}

pub fn get_sample_v2_schedule_json_string() -> Result<String> {
    Ok(read_to_string("src/eos_test_utils/sample-schedule-28-v2.json")?)
}

pub fn get_sample_mainnet_schedule_1713() -> Result<EosProducerScheduleV2> {
    EosProducerScheduleJsonV1::from(&read_to_string("src/eos_test_utils/sample-schedule-1713-v1.json")?)
...
pub fn get_sample_j3_schedule_37() -> Result<EosProducerScheduleV2> {
    EosProducerScheduleJsonV1::from(&read_to_string("src/eos_test_utils/sample-j3-schedule-37.json")?)
        .and_then(|v1_json| EosProducerScheduleV1::from_schedule_json(&v1_json))
        .map(EosProducerScheduleV2::from)
}
