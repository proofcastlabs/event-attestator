...
mod tests {
    ...
    #[test]
    fn should_get_correct_merkle_root_of_empty_receipts() {
        let receipts = EthReceipts::default();
        assert!(receipts.is_empty());
        let result = receipts.get_merkle_root().unwrap();
        let expected_result =
            EthHash::from_str("0x56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421").unwrap();
        assert_eq!(result, expected_result);
    }
}
