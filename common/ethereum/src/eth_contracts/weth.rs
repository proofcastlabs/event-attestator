...
use crate::{convert_h256_to_eth_address, EthLog, EthLogExt, EthReceipt, EthSubmissionMaterial};
...
mod tests {
    ...
    use crate::{
        ...
        eth_contracts::test_utils::get_sample_submission_material_with_weth_deposit,
    };
