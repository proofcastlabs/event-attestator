...
use crate::{
    ...
    eth_crypto::{EthPrivateKey, EthTransaction},
    EthDbUtils,
    EthDbUtilsExt,
    EthSigningCapabilities,
};
...
pub fn encode_mint_by_proxy_tx_data(
    ...
    let proxy_signature = eth_private_key
        .hash_and_sign_msg_with_eth_prefix(&encode(&[
...
mod tests {
    use super::*;
    use crate::test_utils::{get_sample_eth_address, get_sample_eth_private_key};
    ...
    fn should_encode_mint_by_proxy_tx_data() {
        ...
        let expected_result = "";
