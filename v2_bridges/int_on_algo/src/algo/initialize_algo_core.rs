...
mod tests {
    ...
    use super::*;
    use crate::test_utils::get_sample_algo_submission_material_n;
    ...
    fn should_maybe_init_algo_core() {
        ...
        let submission_material = get_sample_algo_submission_material_n(7);
    ...
    fn should_not_init_algo_core_twice() {
        ...
        let db = get_test_database();
        let db_utils = AlgoDbUtils::new(&db);
        let block = get_sample_algo_submission_material_n(7);
        let app_id = 666;
        let genesis_id = "mainnet-v1.0";
