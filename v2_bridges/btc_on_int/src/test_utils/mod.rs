...
write_eth_paths_and_getter_fxn!(
    0 => "src/test_utils/eth-ropsten-block-12000341.json",
    1 => "src/test_utils/eth-ropsten-block-12000342.json",
    2 => "src/test_utils/eth-ropsten-block-12000343.json",
    3 => "src/test_utils/eth-ropsten-block-12000344.json"
);
